    ...
    <header className="border-b-4 border-ink bg-petal">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-5 py-4 md:px-10">
        <Link to="/" className="flex items-center gap-3 no-underline">
          <div className="flex h-11 w-11 items-center justify-center rounded-md border-2 border-ink bg-citrus text-lg font-black text-ink shadow-sticker">
            NF
          </div>
          <div>
        ...
        <nav className="flex flex-wrap items-center gap-3">
          ...
          {isAuthed && (
            <div className="flex items-center gap-3">
              <div className="hidden rounded-full border-2 border-ink bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.08em] text-ink shadow-sticker md:block">
